...
class ImageToVoxelCharacter {
    ...
    init() {
        ...
        // Add voxel character from external system
        this.app.post('/api/add-voxel-character', (req, res) => {
            const character = req.body;
            console.log(`🌉 Adding bridged character: ${character.name}`);
            
            // Store character
            this.voxelCharacters.set(character.id, character);
