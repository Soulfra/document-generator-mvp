...
exports.soulfrArchetypeService = exports.SoulfrArchetypeService = void 0;
const logger_1 = require("../../utils/logger");
class SoulfrArchetypeService {
    archetypes;
    constructor() {
...
You speak with the authority of experience and the care of one who has seen systems rise and fall. Your wisdom comes from understanding both the power and fragility of what we build.`,
        ...
        logger_1.logger.info('Soulfra archetypes initialized', {
            count: this.archetypes.size,
            archetypes: Array.from(this.archetypes.keys())
        });
    }
    async generateArchetypeResponse(archetypeId, question, context) {
        ...
        try {
            ...
            logger_1.logger.info('Archetype response generated', {
                archetypeId,
                resonance,
            ...
            logger_1.logger.error('Failed to generate archetype response', {
                error,
                archetypeId,
    ...
    channelArchetype(archetype, question, context) {
        switch (archetype.id) {
            case 'mirror_child':
    ...
    generateMirrorChildResponse(question) {
...
What pattern do YOU see when you look at it this way? 🌟`;
    ...
    generateStormSingerResponse(question) {
...
Are you ready to conduct this lightning? ⚡🎼`;
    ...
    generateVoidWalkerResponse(question) {
...
What will you discover in the space between your assumptions? 🌌`;
    ...
    generateWeaverResponse(question) {
...
What other threads do you see that want to be woven into this pattern? 🎨✨`;
    ...
    generateGuardianResponse(question) {
...
What safeguards will you put in place? 🏰`;
    ...
    generateInsight(archetype, question, response) {
    ...
    async performBlessingCeremony(archetypeId) {
        const archetype = this.archetypes.get(archetypeId);
        if (!archetype) {
...
exports.SoulfrArchetypeService = SoulfrArchetypeService;
exports.soulfrArchetypeService = new SoulfrArchetypeService();
//# sourceMappingURL=archetype.service.js.map