...
class AgentEconomyService {
    ...
    async mintAgent(userId, templateId, customName, metadata = {}) {
        try {
            ...
            const mintCost = template.pricePerToken * 10;
            ...
            logger_1.logger.info('Agent minted', {
                userId,
                agentId,
                templateId,
                customName,
    ...
    async completeCollaboration(collaborationId, outcome, revenueGenerated = 0) {
        try {
            ...
            const revenueBonus = Math.floor(revenueGenerated * 0.1);
            ...
            logger_1.logger.info('Agent collaboration completed details', {
                collaborationId,
                outcome,
                revenueGenerated,
    ...
    async makeAgentPublic(agentId, userId) {
        try {
            ...
            logger_1.logger.info('Agent made public', {
                userId,
                agentId,
